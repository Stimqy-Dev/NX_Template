...
local Grid = {
    Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 415, Height = 275 },
    Grid = { X = 115.5, Y = 67.5, Width = 184, Height = 200 },
    Circle = { Dictionary = "mpinventory", Texture = "in_world_circle", X = 115.5, Y = 67.5, Width = 20, Height = 20 },
    Text = {
        Top = { X = 210.5, Y = 35, Scale = 0.25 },
        Bottom = { X = 210.5, Y = 270, Scale = 0.25 },
        Left = { X = 57.75, Y = 150, Scale = 0.25 },
        Right = { X = 355.25, Y = 150, Scale = 0.25 },
    },
}
