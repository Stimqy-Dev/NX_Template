Locales["fr"] = {
    ...
    ["command_setcrew"] = "Définir le métier d'un joueur",
    ["command_setcrew_crew"] = "Nom du crew à définir",
    ["command_setcrew_grade"] = "Grade du métier",
    ["command_setcrew_invalid"] = "Le crew, le grade, ou les deux sont invalides",
