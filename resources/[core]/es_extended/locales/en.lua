Locales["en"] = {
    ...
    ["command_setcrew"] = "Set a player`s crew",
    ["command_setcrew_crew"] = "Name",
    ["command_setcrew_grade"] = "Crew grade",
    ["command_setcrew_invalid"] = "the crew, grade or both are invalid",
