        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            for i = 0, segments - 1 do
                ...
                RenderRectangle(
                    ...
                    segmentHeight, 
                    math.floor(intensity * ConfigRageUI.Menu.DegraderBanniere.R * 0.2),
                    math.floor(intensity * ConfigRageUI.Menu.DegraderBanniere.G * 0.2),
                    math.floor(intensity * ConfigRageUI.Menu.DegraderBanniere.B * 0.2),
                    alpha
                )
            end
